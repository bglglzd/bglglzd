<picture>
  ...
  <source media="(prefers-color-scheme: light)" srcset="assets/hero-text-light.svg">
  <img src="assets/hero-text-dark.svg" width="100%" alt="bglglzd — Local intelligence. Useful software. Rust, TypeScript, Kotlin and Python.">
</picture>
...
<picture>
  ...
  <img src="assets/engineering-dark.svg" width="100%" alt="Public engineering snapshot: projects, releases and language mix. Methodology and source data are linked below.">
</picture>

<sub>[About these numbers](docs/metrics.md) · [All public projects](https://github.com/bglglzd?tab=repositories&amp;type=source) · [Let's build something useful ↗](https://github.com/bglglzd/bglglzd/discussions)</sub>
